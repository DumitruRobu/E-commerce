                ...
                $("button[type='submit']").prop("disabled", false);
                    ...
                    if (response.status === false) {
                        if (response.errors && response.errors.name) {
                            $("#name").siblings("p").addClass("invalid-feedback").html(response.errors.name);
                        ...
                        if (response.errors && response.errors.email) {
                            $("#email").siblings("p").addClass("invalid-feedback").html(response.errors.email);
                        ...
                        if (response.errors && response.errors.password) {
                            $("#password").siblings("p").addClass("invalid-feedback").html(response.errors.password);
