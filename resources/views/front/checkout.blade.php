...
<section class="section-9 pt-4">
    <div class="container">
        <form action="{{ route('front.processCheckout') }}" id="orderForm" name="orderForm" method="post">
        <div class="row">
            <div class="col-md-8">
                <div class="sub-title">
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body checkout-form">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <input type="text" name="first_name" id="first_name" class="form-control" placeholder="First Name" value="{{ isset($customerAddress) ? $customerAddress -> first_name : '' }}">
                                    <p></p>
                                </div>            
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <input type="text" name="state" id="state" class="form-control" placeholder="State (optional)" value='{{ (!empty($customerAddress)) ? $customerAddress -> state : "" }}'>
                                </div>            
                            </div>
                    ...
                    <div class="card-body">
                        @foreach (Cart::content() as $item)
                            <div class="d-flex justify-content-between pb-2">
                                ...
                                <div class="h6">{{ $item -> price * $item -> qty }} MDL</div>
                            </div>
                        @endforeach
                        ...
                        <div class="d-flex justify-content-between summery-end">
                            ...
                            <div class="h6"><strong>{{ Cart::subtotal() }} MDL</strong></div>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            <div class="h6"><strong>Shipping</strong></div>
                            <div class="h6"><strong>0 MDL</strong></div>
                        </div>
                        <div class="d-flex justify-content-between mt-2 summery-end">
                            <div class="h5"><strong>Total</strong></div>
                            <div class="h5"><strong>{{ Cart::subtotal() }} MDL</strong></div>
                        </div>                            
                    </div>
                </div>   
