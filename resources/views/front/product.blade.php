    ...
    <section class="section-7 pt-3 mb-3">
        <div class="container">
            <div class="row ">
                    ...
                    <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light">
                            @if ($product->product_images->count() > 0)
                                @foreach ($product->product_images as $key => $additional_image)
                                    <div class="carousel-item{{ ($key == 0) ? ' active' : '' }}">
                                        <img class="w-100 h-100" src="{{ $additional_image->image_url }}" alt="Additional Image">
                                    </div>
                                @endforeach
                            @endif
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="{{ $product -> main_image }}" alt="Image">
                            </div>
                        </div>
                ...
                <div class="col-md-7">
                    <div class="right ProductContennt">
                        <h1>{{ $product -> title }}</h1>
                        ...
                        @if ($product -> compare_price > 0)
                            <h2 class="price text-secondary"><del>{{ $product -> compare_price }} MDL</del></h2>
                        @endif

                        
                        <h2 class="price ">{{ $product -> price }} MDL</h2>
                ...
                <div class="col-md-12 mt-5">
                    <div class="productTabContent">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad beatae blanditiis, ipsam, voluptates placeat excepturi vitae ullam quod, dolor consectetur nemo aspernatur quas natus praesentium?</p>
                            </div>
                        </div>
                    </div>
                </div> 
